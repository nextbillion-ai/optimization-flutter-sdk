...
class OptLatLng {
  ...
  const OptLatLng(double latitude, double longitude)
      : latitude =
  ...
  OptLatLng operator +(OptLatLng o) {
    return OptLatLng(latitude + o.latitude, longitude + o.longitude);
  }
  ...
  static OptLatLng _fromJson(List<dynamic> json) {
    return OptLatLng(json[0], json[1]);
  }
...
class OptLatLngBounds {
  /// Creates geographical bounding box with the specified corners.
  ///
  /// The latitude of the southwest corner cannot be larger than the
  /// latitude of the northeast corner.
  OptLatLngBounds({required this.southwest, required this.northeast})
  ...
  @override
  bool operator ==(Object other) {
    return other is OptLatLngBounds &&
...
class OptLatLngQuad {
  ...
  final OptLatLng topLeft;

  final OptLatLng topRight;

  final OptLatLng bottomRight;

  final OptLatLng bottomLeft;
